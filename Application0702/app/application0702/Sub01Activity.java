...
public class Sub01Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toMainBtn = findViewById(R.id.sub01_button_toMain);
        toSub01Btn = findViewById(R.id.sub01_button_toSub01);
        toSub02Btn = findViewById(R.id.sub01_button_toSub02);
        toSub03Btn = findViewById(R.id.sub01_button_toSub03);
    ...
    public void onClick(View view) {
        ...
        if(id == R.id.sub01_button_toMain) {
            intent = new Intent(this, MainActivity.class);
        }else if(id == R.id.sub01_button_toSub01) {
            intent = new Intent(this, Sub01Activity.class);
        }else if(id == R.id.sub01_button_toSub02) {
            intent = new Intent(this, Sub02Activity.class);
        }else if(id == R.id.sub01_button_toSub03) {
